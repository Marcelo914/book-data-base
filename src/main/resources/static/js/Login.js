...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var botaoSubmitCadastrar = document.getElementById("botaoSubmitCadastrar");
    ...
    if (
        (submitLink || botaoSubmitCadastrar) &&
        usernameInput &&
        passwordInput &&
        errorPopup &&
        errorMessage &&
        ...
        botaoSubmitCadastrar.addEventListener("click", async function(event) {
                    ...
                    try {
                        ...
                        if (response.ok && result.success) {
                            ...
                            errorMessage.innerHTML =
                                result.message || "Erro ao fazer o cadastro.";
                            errorPopup.style.display = "block";
                        }
                    } catch (error) {
